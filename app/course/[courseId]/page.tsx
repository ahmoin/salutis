		...
		return (
			<div className="min-h-screen p-8">
				<div className="max-w-4xl mx-auto">
					...
					<p className="mb-4">You must be enrolled in this course to view it.</p>
					<Button onClick={() => router.push("/")}>
						<ArrowLeft className="w-4 h-4 mr-2" />
						Back to Dashboard
					</Button>
				...
				<div className="mb-8">
					...
					<div className="flex items-center justify-between mb-4">
						...
						<Badge variant={userCourse.isCompleted ? "default" : "secondary"}>
							{userCourse.isCompleted ? "Completed" : `${progressPercentage}% Complete`}
						</Badge>
					</div>
							...
							<Card key={module} className="transition-all hover:shadow-md">
								...
								<CardContent>
									<p className="text-muted-foreground">
										This module covers important aspects of {module.toLowerCase()}. 
										Complete this module to progress in your mental health journey.
									</p>
								</CardContent>
							</Card>
						);
						...
						<CardContent className="pt-6">
							<div className="text-center">
								...
								<p className="text-green-700">
									You have successfully completed the {course.title}. 
									Great job on your mental health journey!
								</p>
							</div>
						</CardContent>
					</Card>
